...
<body>
  <div style="line-height:23px;">
    ...
    <div style="margin-top: 15px;">
      <div style="font-weight: bold; text-align: center; margin-bottom: 20px;">{{ $notulen->rapat->jenis_rapat->nama }}
      </div>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="line-height:23px;">
        ...
        <tr>
          <td>Hari, tanggal</td>
          <td>:&nbsp; {{ Carbon\Carbon::createFromDate($notulen->rapat->tanggal)->translatedFormat('l, jS F Y') }}</td>
        </tr>
        <tr>
          <td>Waktu</td>

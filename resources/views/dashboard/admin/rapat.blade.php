                    ...
                    @foreach ($rapat as $rpt)
                      <tr>
                        ...
                        <td style="white-space: nowrap;">
                          ...
                          @can('admin')
                            <form action="{{ route('delete.rapat', $rpt->slug) }}" method="post" class="d-inline">
                              {{ csrf_field() }}
                              @method('delete')
                              <button onclick="return confirm('Semua data pada rapat ini akan terhapus. Lanjutkan?')"
                            ...
                            <form action="{{ route('update.rapat', $rpt->slug) }}" method="post">
                              <div class="modal-body">
                                ...
                                <div class="form-row mb-3">
                                  <div class="col-6">
                                    <label for="pimpinan_rapat">Pimpinan Rapat</label>
                                    <input name="pimpinan_rapat" type="text" class="form-control"
                                      id="pimpinan_rapat" value="{{ old('pimpinan_rapat', $rpt->pimpinan_rapat) }}"
                                      required>
                                  </div>
                                  <div class="col-6">
                                    <label for="nip_pimpinan">NIP</label>
                                ...
                                <div class="form-row mb-3">
                                  ...
                                  <div class="col-6">
                                    ...
                                    <select name="status" class="form-control" id="status" required>
                                      <option value="">Pilh ...</option>
                                      <option value="belum dimulai" @if (old('status', $rpt->status == 'belum dimulai')) selected @endif>
                                        Belum
                                        dimulai</option>

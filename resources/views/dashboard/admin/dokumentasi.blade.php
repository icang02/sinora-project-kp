  ...
  <div class="modal fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="{{ route('upload.dokumentasi', 1) }}" method="post" enctype="multipart/form-data">
          <div class="modal-body">
            @csrf
            <div class="form-group">
              {{-- <label for="foto"></label> --}}
              <input multiple name="foto[]" type="file" class="form-control" id="foto" required accept="image/*">
              <div class="text form text-muted mt-2">Pilh beberapa gambar sekaligus. Ukuran gambar tidak lebih dari 2MB.
              </div>
            </div>
          </div>
            ...
            <div class="card-header">
              <div class="row">
                ...
                <div class="col-md-6 col-12 d-md-flex justify-content-end">
                  <h5 class="card-title">
                    <a href="{{ route('detail.rapat', $rapat->slug) }}" class="btn btn-secondary btn-sm">Kembali</a>
                  </h5>
                </div>
              </div>
            </div>
                    ...
                    @foreach ($rapat->dokumentasi as $index => $item)
                      <div class="col-sm-2 text-center">
                        ...
                        <a href="{{ asset("storage/$item->foto") }}?img={{ $index + 1 }}" data-toggle="lightbox"
                          ...
                          <img src="{{ asset("storage/$item->foto") }}?img={{ $index + 1 }}" class="img-fluid mb-2"
                            alt="white sample" />
                        </a>
                      </div>
                    @endforeach
